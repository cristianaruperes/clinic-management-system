...
@section('content')
    ...
    <div class="container-xl">
          ...
          <div class="col-auto">
            ...
            <div class="page-pretitle">
              <ol class="breadcrumb breadcrumb-arrows" aria-label="breadcrumbs">
                ...
                <li class="breadcrumb-item active" aria-current="page"><a href="#">Tambah Dokter</a></li>
              </ol>
            </div>
            <h2 class="page-title">
              Tambah Dokter Baru
      ...
      <div class="row">
        <div class="col-12">
          <form action="{{ route('save.doctor') }}" method="post" class="card" enctype="multipart/form-data">
            @csrf
