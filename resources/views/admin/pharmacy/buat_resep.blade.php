...
<div class="container-xl">
  ...
  <div class="card">
    ...
    <!-- <div class="card-footer text-right">
          <div class="d-flex">
            <a href="{{ route('list.pharmacy.rekam_medis', ['id' => $record->patient->id]) }}" class="btn btn-link">Kembali</a>
          </div>
        </div> -->
  </div>

  <div class="card">
    <form action="{{ route('save.pharmacy.resep') }}" method="post" enctype="multipart/form-data">
      @csrf
      ...
      <div class="card-body">
        ...
        <input name="resep_id" value="{{$record->resep->id}}" hidden>
        ...
        <div class="row">
          <div class="col-6">
              ...
              <div class="col">
                <div class="form-selectgroup form-selectgroup-boxes d-flex flex-row">
                  ...
                  <label class="form-selectgroup-item flex-fill">
                    <input type="radio" name="alergi" value="ya" class="form-selectgroup-input" @if ($record->resep->alergi == 'ya') checked @endif>
                  ...
                  <label class="form-selectgroup-item flex-fill">
                    <input type="radio" name="alergi" value="tidak" class="form-selectgroup-input" @if ($record->resep->alergi == 'tidak') checked @endif>
                    <div class="form-selectgroup-label d-flex align-items-center p-3">
                      <div class="mr-3">
                        <span class="form-selectgroup-check"></span>
                      </div>
            ...
            <div class="form-group mb-3 row">
              ...
              <div class="col">
                <input type="text" class="form-control" name="keterangan_alergi" value="{{ $record->resep->keterangan_alergi }}">
              </div>
            </div>
            ...
            <div class="form-group mb-3 row">
              ...
              <div class="col">
                ...
                <div class="form-selectgroup form-selectgroup-boxes d-flex flex-row">
                  ...
                  <label class="form-selectgroup-item flex-fill">
                    <input type="radio" name="hamil" value="ya" class="form-selectgroup-input" @if ($record->resep->hamil == 'ya') checked @endif>
                    <div class="form-selectgroup-label d-flex align-items-center p-3">
                      <div class="mr-3">
                        <span class="form-selectgroup-check"></span>
                      </div>
                  ...
                  <label class="form-selectgroup-item flex-fill">
                    <input type="radio" name="hamil" value="tidak" class="form-selectgroup-input" @if ($record->resep->hamil == 'tidak') checked @endif>
                    <div class="form-selectgroup-label d-flex align-items-center p-3">
                      <div class="mr-3">
                        <span class="form-selectgroup-check"></span>
                      </div>
            ...
            <div class="form-group mb-3 row">
              ...
              <div class="col">
                <div class="form-selectgroup form-selectgroup-boxes d-flex flex-row">
                  ...
                  <label class="form-selectgroup-item flex-fill">
                    <input type="radio" name="menyusui" value="ya" class="form-selectgroup-input" @if ($record->resep->menyusui == 'ya') checked @endif>
                    <div class="form-selectgroup-label d-flex align-items-center p-3">
                      <div class="mr-3">
                        <span class="form-selectgroup-check"></span>
                      </div>
                  ...
                  <label class="form-selectgroup-item flex-fill">
                    <input type="radio" name="menyusui" value="tidak" class="form-selectgroup-input" @if ($record->resep->menyusui == 'tidak') checked @endif>
                    <div class="form-selectgroup-label d-flex align-items-center p-3">
                      <div class="mr-3">
                        <span class="form-selectgroup-check"></span>
                      </div>
  ...
  <div class="card">
    <form action="{{ route('add.pharmacy.medicine') }}" method="post" enctype="multipart/form-data">
      @csrf
      ...
      <table class="table card-table table-vcenter text-nowrap datatable">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>{{ $obat->jumlah }}</td>
            <td>{{ $obat->dosis }}</td>
            <td>Rp. {{ ($obat->medicine->harga_jual) ? number_format($obat->medicine->harga_jual) : "0" }}</td>
            <td>Rp. {{ ($obat->harga) ? number_format($obat->harga) : "0" }}</td>
            <td class="text-right">
              <a href="{{ route('delete.pharmacy.medicine', ['id' => $obat->id]) }}" onclick="return confirm('Are you sure?')">Hapus</a>
            </td>
          </tr>
          @endforeach
          <tr>
