          ...
          <div class="col-auto ml-auto d-print-none">
            <div class="d-flex">
              <div class="mr-3">
                ...
                <form method="get" action="{{ route('search.medicines') }}">
                        ...
                        <td class="text-right">
                          <span class="dropdown ml-1">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                              ...
                              <a class="dropdown-item" href="{{ route('edit.medicines', ['id' => $medicine->id]) }}">
                                Edit Obat
                              </a>
                              <a class="dropdown-item" href="{{ route('delete.medicines', ['id' => $medicine->id]) }}">
                                Hapus
                              </a>
                            </div>
                          </span>
