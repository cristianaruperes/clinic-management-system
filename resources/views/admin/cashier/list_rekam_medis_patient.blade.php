          ...
          <div class="col-auto">
            ...
            <div class="page-pretitle">
              <ol class="breadcrumb breadcrumb-arrows" aria-label="breadcrumbs">
                ...
                <li class="breadcrumb-item active" aria-current="page"><a href="#">Rekam Medis Rawat Jalan</a></li>
              </ol>
            </div>
            <h2 class="page-title">
                      ...
                      <td class="text-right">
                        <span class="dropdown ml-1">
                          ...
                          <div class="dropdown-menu dropdown-menu-right">
                            <a class="dropdown-item" href="{{ route('show.payment.patient', ['id' => $record->id]) }}">
                              Pembayaran
                            </a>
