    ...
    <div class="container-xl">
      ...
      <div class="page-header">
        <div class="row align-items-center">
          ...
          <a href="{{ route('add.room') }}" class="btn btn-primary ml-3 d-none d-sm-inline-block">
          ...
          <table class="table card-table table-vcenter text-nowrap datatable">
            ...
            <tbody>
              @if (isset($rooms))
                  ...
                  <tr>
                      <td>{{ $room->name }}</td>
                      <td>Rp. {{ ($room->price) ? number_format($room->price) : "0" }}</td>
                      <td class="text-right">
                        <span class="dropdown ml-1">
                          ...
                          <div class="dropdown-menu dropdown-menu-right">
                            <a class="dropdown-item" href="{{ route('edit.room', ['id' => $room->id]) }}">
                              Edit
                            </a>
                            <a class="dropdown-item" onclick="return confirm('Are you sure?')" href="{{ route('delete.room', ['id' => $room->id]) }}">
                              Hapus
                            </a>
                          </div>
                        </span>
